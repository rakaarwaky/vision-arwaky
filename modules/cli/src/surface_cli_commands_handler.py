...
import os
import asyncio
from modules.shared.src.common.taxonomy_vision_models_vo import FilePath, LanguageCode, BoundingBox, TimeSegment, IntervalSeconds, AnalysisPrompt
...
def cmd_analyze(args):
    ...
    from modules.shared.src.common.taxonomy_vision_models_vo import AnalysisPrompt
...
def cmd_detect_scenes(args):
    ...
    from modules.shared.src.common.taxonomy_vision_models_vo import SceneThreshold
...
def cmd_detect_motion(args):
    svc = VideoOrchestrator.get_video_analysis()
    from modules.shared.src.common.taxonomy_vision_models_vo import MinArea
...
def cmd_track(args):
    ...
    from modules.shared.src.common.taxonomy_vision_models_vo import MaxFrames
...
def cmd_timeline(args):
    ...
    from modules.shared.src.common.taxonomy_vision_models_vo import IntervalSeconds
    interval = IntervalSeconds(value=float(args.interval))
    ...
    if os.path.exists(test_image):
        ...
        try:
            ...
            if vision_result.returncode == 0:
                ...
                # fallback langsung
                from modules.image.src.agent_image_orchestrator import ImageOrchestrator
                from modules.shared.src.common.taxonomy_vision_models_vo import FilePath, AnalysisPrompt
                svc = ImageOrchestrator.get_image_processing()
