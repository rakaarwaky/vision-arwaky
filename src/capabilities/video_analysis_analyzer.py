...
from src.contract import VideoAnalysisProtocol
from src.contract import OpenCVImagePort
from src.taxonomy.vision_models_vo import SceneChange, MotionEvent, BoundingBox, FilePath, SceneThreshold, MinArea
